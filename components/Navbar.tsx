    ...
    <header className="fixed top-0 left-0 z-50 w-full border-b border-white/10 bg-surface/80 backdrop-blur-3xl">
      <div className="mx-auto flex max-w-full items-center justify-between px-6 py-4">
        <div className="flex min-w-0 items-center gap-6 md:gap-10">
          <Link
            href="/"
            className={`${spaceGrotesk.className} shrink-0 text-[26px] font-light tracking-[0.2em] text-accent transition-all duration-300 hover:opacity-80`}
          >
            zentra
          </Link>
            ...
            {tabs.map((tab) => {
              ...
              return (
                <Link
                  ...
                  className={`${spaceGrotesk.className} flex shrink-0 items-center gap-1.5 border-b-2 pb-1.5 pt-1 text-[12px] font-bold uppercase tracking-widest transition-all duration-300 ${
                    isActive
        ...
        <div className="flex shrink-0 items-center gap-1">
          <Show when="signed-out">
            <SignInButton mode="modal">
              <button
                type="button"
                className={`${spaceGrotesk.className} px-3 py-2 text-[11px] font-bold uppercase tracking-widest text-white/60 transition-colors duration-150 hover:text-accent active:scale-95`}
              >
                Sign In
              </button>
            </SignInButton>
            <SignUpButton mode="modal">
              <button
                type="button"
                className={`${spaceGrotesk.className} px-3 py-2 text-[11px] font-bold uppercase tracking-widest text-accent transition-colors duration-150 hover:text-white active:scale-95`}
              >
                Sign Up
              </button>
            </SignUpButton>
